    ...
    >
      <div className="bg-card/60 backdrop-blur-md rounded-xl neon-border p-5">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: "TOTAL KILLS", value: stats.totalKills, icon: "💀", suffix: "" },
            { label: "BEST COMBO", value: stats.bestCombo, icon: "🔥", suffix: "x" },
            { label: "GAMES PLAYED", value: stats.gamesPlayed, icon: "🎮", suffix: "" },
          ].map((s) => (
        ...
        <div className="grid grid-cols-2 gap-3 mt-3 pt-3 border-t border-border/30">
          <div className="text-center">
            <p className="font-display text-sm text-[hsl(var(--neon-yellow))]">
              <AnimatedStat value={stats.totalScore} />
            </p>
            <p className="font-body text-[9px] text-muted-foreground">TOTAL SCORE</p>
          </div>
          <div className="text-center">
            <p className="font-display text-sm text-accent">
              <AnimatedStat value={stats.highestWave} />
            </p>
